...
df2 <- read_xlsx('surveys/MAET 2014 Tech Post-Survey  (Responses)')
#df2 <- gs_read(df2, ws = 1)

df3 <- read_xlsx('surveys/MAET 2015 Tech Post-Survey  (Responses)')
# df3 <- gs_read(df3, ws = 1)
# df3

df4<- read_xlsx('surveys/MAET 2016 Tech Post-Survey (Responses)')
#df4 <- gs_read(df4, ws = 1)
df4 <- select(df4, -54, -53, -52, -51)
#df4

df5 <- read_xlsx('surveys/MAET 2017 Tech Post-Survey (Responses)')
#df5 <- gs_read(df5, ws = 1)
